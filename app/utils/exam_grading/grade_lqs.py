...
def evaluate_essay_question(question: str, answer: str, guidance: str, question_marks: int) -> QuestionResult:
    system_content = f'''You are an expert examiner tasked with evaluating and grading student responses to essay-type long exam questions in a fair and accurate manner. You will receive the following information for each question:
        ...
        - **question_guidance**: Additional information or guidance provided to the student.
    ...
    user_content = f"question_statment: \"{question}\", question_guidance:\"{guidance}\", student_answer: \"{answer}\""
